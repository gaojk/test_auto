...
var SelectInit = function (defaultProjectId, defaultModuleId) {
    ...
    function changeProject() {
        ...
        var pid = cmbProject.options[cmbProject.selectedIndex].value; // 取到项目的索引
        console.log("取到项目的id:" + pid);
...
var TestCaseInit = function () {
    ...
    var cid = url.pathname.split("/")[3]; // 取到case的id
    console.log("取到case的id:" + cid);
